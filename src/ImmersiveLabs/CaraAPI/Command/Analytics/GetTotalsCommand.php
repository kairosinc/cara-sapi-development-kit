...
class GetTotalsCommand extends BaseCommand
{
    protected function configure()
    {
        $this
            ->setName('analytics:get_totals')
            ->setDescription('Get total stats')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $raw = $this->getAnalyticsAPIService()->getTotals($accessToken, $cameraKey, $from, $to, $gender, $age);
